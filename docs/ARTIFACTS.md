...
|---|---|---|---|
| **parsed** | ✅ 성공 | **⚠️ 확정 필요** — 후보: `korplan_ar_rk_gated_seed42_roomperm_ep?` · `korplan_ar_k_g256_ftR_b?_ep?` | `tokens_korean_{clean\|gated}{_g256}` + RPLAN |
...
- 옛 AR 실험·중간 에폭 (`ckpts/` 대부분) — 정본 ep만 남기고
