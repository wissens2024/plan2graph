...
|---|---|---|---|
| **g0** | dual | 4,796 | **8,700** |
| **g1** | dual + spa_only·str_only·objocr 복구 | 19,826 | **40,495** |
...
- g1 도면 19,826 = AI-Hub에서 **SPA(실라벨 or objocr 예측) 확보분**(43,219 중 excl 22,886·SPA결손분 제외). g0=dual만(재빌드 전후 동일 8,700, 시드·dual 불변).
