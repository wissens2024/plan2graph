...
if which.startswith("📊"):
    ...
    st.title("📊 위상 모델 결과")
    st.caption("위상 생성 AI 비교(데이터셋 · 생성기 · 구성요소, 동결 벤치마크). " )
...
if which.startswith("📈"):
    ...
    st.table([
        {"버전": "v0", "데이터셋 구성 (합쳐서 한 모델, 세대 그래프 기준)":
         "AI-Hub 3,324도면→7,101세대 (dual 클린, 기준선)", "상태": "완료"},
        {"버전": "v1", "데이터셋 구성 (합쳐서 한 모델, 세대 그래프 기준)":
         "AI-Hub 10,063도면→20,828세대", "상태": "완료"},
        {"버전": "v2", "데이터셋 구성 (합쳐서 한 모델, 세대 그래프 기준)":
         "AI-Hub 10,063도면→20,828세대 + CubiCasa 3,028", "상태": "완료"},
        {"버전": "v3", "데이터셋 구성 (합쳐서 한 모델, 세대 그래프 기준)":
         "AI-Hub 10,063도면→20,828세대 + RPLAN 80,371", "상태": "완료"},
        {"버전": "v4", "데이터셋 구성 (합쳐서 한 모델, 세대 그래프 기준)":
         "AI-Hub 10,063도면→20,828세대 + CubiCasa 3,028 + RPLAN 80,371", "상태": "완료"},
        {"버전": "v5", "데이터셋 구성 (합쳐서 한 모델, 세대 그래프 기준)":
         "RPLAN 80,371 (글로벌만)", "상태": "완료"},
        {"버전": "v6", "데이터셋 구성 (합쳐서 한 모델, 세대 그래프 기준)":
         "CubiCasa 3,028 (글로벌만)", "상태": "완료"},
        {"버전": "v7", "데이터셋 구성 (합쳐서 한 모델, 세대 그래프 기준)":
         "RPLAN 80,371 + CubiCasa 3,028 (글로벌만)", "상태": "완료"},
    ])
    st.caption("**AI-Hub는 도면 1장 = 다세대**라 도면수≠세대수(예: 10,063도면→20,828세대) → 병기. "
               "글로벌(RPLAN·CubiCasa)은 도면=세대 1:1이라 단일 숫자. 학습·표 수치는 **세대 그래프** 기준.")
