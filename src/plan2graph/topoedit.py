...
DRAW_BASES = ("복도", "발코니", "다목적공간", "실외기실", "드레스룸", "파우더룸",
              "기타", "거실", "주방", "침실", "욕실", "현관", "알파룸", "펜트리")
...
ROLES = ("거실", "주방", "현관", "침실", "안방", "욕실", "파우더룸", "드레스룸",
         "발코니", "실외기실", "다목적공간", "복도", "펜트리",
         "기타", "구조물", "실외", "엘리베이터홀", "계단실", "엘리베이터", "알파룸")

ROLE_COLOR = {
    "침실": "#6CA6E8", "안방": "#1f6fd6", "거실": "#E8453C", "주방": "#F2A900",
    "욕실": "#3a9a3a", "현관": "#d9534f", "발코니": "#2DBE60", "드레스룸": "#a070d0",
    "복도": "#9aa0a6", "파우더룸": "#d08ac0", "펜트리": "#caa46a", "기타": "#bcbcbc",
    "실외기실": "#9cc8e8", "다목적공간": "#fdc08a",
    "계단실": "#888", "엘리베이터": "#888", "엘리베이터홀": "#888", "실외": "#ddd",
    "알파룸": "#26a69a",
    # 레거시 별칭(기존 데이터 렌더용; 통일됨 → 욕실/현관). picker엔 안 뜸.
    "화장실": "#3a9a3a", "전용욕실": "#3a9a3a", "전용화장실": "#3a9a3a", "전실": "#d9534f",
}
...
def suggest_roles(st: State, dr: Drawing) -> dict:
    ...
    NAME = (("안방", "안방"), ("드레스", "드레스룸"), ("파우더", "파우더룸"),
            ("펜트리", "펜트리"), ("팬트리", "펜트리"),
            ("부부욕실", "욕실"), ("부부", "욕실"), ("욕실", "욕실"), ("화장실", "욕실"),
            ("주방", "주방"), ("식당", "주방"), ("거실", "거실"),
            ("전실", "현관"), ("현관", "현관"),   # 통일: 화장실→욕실, 전실→현관(원본은 전실도 '현관' 라벨)
